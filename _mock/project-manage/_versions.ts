...
export const Versions = {
    '/project-manage/versions': (req: MockRequest) => getDatas(req.queryString),
    'DELETE /project-manage/versions': (req: MockRequest) => removeDatas(req.queryString.key),
    'POST /project-manage/versions': (req: MockRequest) => saveDatas(req.body),
    'PUT /project-manage/versions': (req: MockRequest) => editDatas(req.body)
};
