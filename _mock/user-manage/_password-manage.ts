...
export const PasswordManage = {
    '/user_manager/password-manage': (req: MockRequest) => getRolesDatas(req.queryString),
    // '/user_manager/user_register?flag=1': (req: MockRequest) => getPrivilegeDatas(req.queryString),
